...
my @tests = (
    ...
    [ destroy_direct_message => sub { [ $message_id  ] }, { id => $message_id }, DELETE => "/direct_messages/events/destroy.json", __LINE__ ],
    ...
    [ direct_messages        => sub { [] }, {},                    GET  => "/direct_messages/events/list.json", __LINE__               ],
    ...
    [ show_direct_message    => sub { [ 1234 ] }, { id => 1234 }, GET => '/direct_messages/events/show.json', __LINE__ ],
